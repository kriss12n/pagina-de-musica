...
<head>
	...
	<title>Punk Goes Pop</title>
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="css/reproductor.css">
	<link href="vendor4/bootstrap/css/bootstrap.min.css" rel="stylesheet">
 <link href="vendor4/reproductor/css/style.css" rel="stylesheet">
	...
	<div class="container-fluid center"style=" margin-top:100px;">
		...
		<div class="masthead-content">
			<div class="container">
				...
				<h1 class="masthead-subheading mb-0 titulo ">Punk Goes Pop</h1>
				<h4 class="masthead-subheading mb-0 titulo ">Volumen 5</h4>
			</div>
		</div>
								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<th scope="row">2</th>
											<td>MAYDAY PARADE</td>
											<td>Somebody That You</td>
											<td>2012</td>
											<td>03:31</td>
				 ~										<tr>
											<th scope="row">3</th>
											<td>WE CAME AS ROMANS</td>
											<td>I Gland You Came</td>
											<td>2012</td>
											<td>03:03</td>
										</tr>
...
<script src="vendor4/bootstrap/js/bootstrap.bundle.min.js"></script>

<script src="vendor4/reproductor/js/index.js"></script>
